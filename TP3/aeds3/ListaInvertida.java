...
public class ListaInvertida {
  ...
  //Arquivo padrão de lista invertida
  public ListaInvertida()throws Exception{
  
    this(4, "dados/dicionario.listainv.db", "dados/blocos.listainv.db");
  }
  ...
  public void print() throws Exception {
    ...
    while (arqDicionario.getFilePointer() != arqDicionario.length()) {
      ...
      System.out.print(new String(chave.getBytes("UTF-8"), "UTF-8") + ": "); // Garante que a codificação esteja correta
        lista.sort(null);
        for (int j = 0; j < lista.size(); j++)
